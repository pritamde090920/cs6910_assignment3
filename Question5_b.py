...
from ModelForTestAttention import RunTestOnBestModel
...
def main():
    ...
    wandb.login()
    wandb.init(project="Pritam CS6910 - Assignment 3",name="Question 5 Attention Predictions")
    wandb.log({"Attention Predictions":wandb.Image(image)})
    wandb.finish()

    #test accuracy 0.42333984375
